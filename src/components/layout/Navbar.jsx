      ...
      <Container>
        <div className="flex items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-8 font-medium">
            ...
            <Link
              to="/order"
              className="ml-4 inline-flex items-center gap-2 bg-emerald-700 text-white px-5 py-2 rounded-full text-sm font-medium hover:bg-emerald-600 hover:shadow-md hover:-translate-y-px transition-all duration-300"
            >
              Order Online
